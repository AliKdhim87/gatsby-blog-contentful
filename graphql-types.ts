...
export type HeaderBackgroundQueryQueryVariables = Exact<{ [key: string]: never; }>;


export type HeaderBackgroundQueryQuery = { placeholderImage?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> };
